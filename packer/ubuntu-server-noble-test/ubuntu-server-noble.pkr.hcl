...
variable "ssh_id_ed25519_pub_key" {
    type      = string
    sensitive = true
}
...
source "proxmox-iso" "ubuntu-server-noble-test" {
    ...
    vm_id                = "350"
    vm_name              = "ubuntu-server-noble-test"
    ...
    # http_bind_address       = "192.168.50.205"
    # http_port_min           = 8802
    # http_port_max           = 8802
...
build {
    ...
    name    = "ubuntu-server-noble-test"
    sources = ["source.proxmox-iso.ubuntu-server-noble-test"]
